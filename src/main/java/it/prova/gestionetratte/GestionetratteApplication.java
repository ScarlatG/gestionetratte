...
public class GestionetratteApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Tratta trattaMilanoNapoli = new Tratta("HJKGJ678", "Milano-Napoli", LocalDate.now(), LocalTime.of(10, 0),
		...
		Tratta trattaMilanoTokyo = new Tratta("KKOOP67", "Milano-Tokyo", LocalDate.of(2022, 12, 1), LocalTime.of(10, 0),
				LocalTime.of(18, 30), Stato.CONCLUSA, airbus2);
		if (trattaService.findByCodiceAndDescrizione(trattaMilanoTokyo.getCodice(), trattaMilanoNapoli.getDescrizione())
				.isEmpty()) {
